...
public class MultiSctpXMLBinding extends XMLBinding {
	...
	protected static final XMLFormat<AssociationMap<String, ManageableAssociation>> ASSOCIATION_MAP_ONE_TO_ONE = new XMLFormat<AssociationMap<String, ManageableAssociation>>(null) {

		@Override
		public void write(AssociationMap<String, ManageableAssociation> obj, javolution.xml.XMLFormat.OutputElement xml) throws XMLStreamException {
		...
		@Override
		public void read(javolution.xml.XMLFormat.InputElement xml, AssociationMap<String, ManageableAssociation> obj) throws XMLStreamException {
			while (xml.hasNext()) {
	...
	protected static final XMLFormat<AssociationMap<String, ManageableAssociation>> ASSOCIATION_MAP_ONE_TO_MANY = new XMLFormat<AssociationMap<String, ManageableAssociation>>(null) {
